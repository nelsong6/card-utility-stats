...
/// <summary>
/// Tests for Akabeko relic stat data model, persistence, and tooltip
...
public class AkabekoStatsTests
{
    ...
    [Fact]
    public void RelicAggregate_VigorGained_AccumulatesAcrossTriggers()
    {
        var run = new RunData();
    ...
    public void RelicTooltip_VigorGained_ShowsVigorIconAndTotal()
    {
        ...
        Assert.Contains("vigor_power.tres", body);
        Assert.Contains("vigor gained", body);
