...
/// <summary>
/// Tests for Akabeko relic stat data model, persistence, and presentation.
/// Live RunTracker integration is exercised by the verification phase via
/// live in-run MCP evidence.
/// </summary>
