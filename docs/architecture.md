...
- [Core/Patches/PotionCompendiumRunHistoryPatch.cs](../Core/Patches/PotionCompendiumRunHistoryPatch.cs) adds the potion-gallery mode dropdown and replaces the rarity galleries with a vertical current-run timeline of native, hoverable potion holders when selected.
