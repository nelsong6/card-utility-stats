...
public class RelicAggregate
{
    ...
    // played last turn) and Gremlin Horn (draws after enemy death).
    ...
    // (gains after enemy death), and Prismatic Gem (adds 1 max energy,
    // counted once per player energy reset).
