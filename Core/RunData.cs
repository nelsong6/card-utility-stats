...
public class RunData
{
    ...
    // v19: add EnergyGenerated to RelicAggregate for Happy Flower every-3-turns
    //      energy contribution tracking. Also additive; older v18 files remain
    //      resumable with the new field defaulting to 0.
...
public class RelicAggregate
{
    ...
    // Total energy generated by this relic across the run.
    // Used by Happy Flower (gains 1 energy every 3 turns at turn start).
