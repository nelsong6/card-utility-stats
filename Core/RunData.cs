...
public class RunData
{
    ...
    //      the new field defaulting to 0.
    // v17: add HpHealed to RelicAggregate for Blood Vial combat-start heal.
    //      Also additive; older v16 files remain resumable with the new field
    //      defaulting to 0.
...
public class RelicAggregate
{
    ...
    // Total HP healed by this relic across all combats.
    // Used by Blood Vial (heals player at combat start).
