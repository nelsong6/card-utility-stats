...
/// the total Vigor contributed across the run.
/// </summary>
[HarmonyPatch]
public static class AkabeloBeforeSideTurnStartPatch
{
    ...
    public static void Postfix(CombatSide side, ICombatState combatState)
    {
        try
        {
            ...
            RunTracker.RecordAkabeloVigorGained(8);
        }
        catch (Exception e)
        {
            CoreMain.LogDebug($"AkabeloBeforeSideTurnStartPatch failed: {e.Message}");
        }
    }
}
