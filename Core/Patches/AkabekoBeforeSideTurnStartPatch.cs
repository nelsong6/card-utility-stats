...
/// <summary>
/// Records Akabeko's combat-start Vigor grant so the relic tooltip can show
/// total Vigor gained across the run.
/// </summary>
[HarmonyPatch]
public static class AkabekoBeforeSideTurnStartPatch
{
    private const int AkabekoVigorAmount = 8;
    ...
    public static void Postfix(CombatSide side, ICombatState combatState)
    {
        try
        {
            ...
            RunTracker.RecordAkabekoVigorGained(AkabekoVigorAmount);
        }
        catch (Exception e)
        {
